...
<!-- LATEST-REPOS-START -->
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/yashKappa" style="color: #58a6ff; text-decoration: none;">yashKappa</a></h3><p style="font-size: 14px;">No description available</p><p style="font-size: 12px;"><b>Language:</b> Unknown</p></div></p>
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/Toriko-Food-ingredients-" style="color: #58a6ff; text-decoration: none;">Toriko-Food-ingredients-</a></h3><p style="font-size: 14px;">No description available</p><p style="font-size: 12px;"><b>Language:</b> JavaScript</p></div></p>
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/Flutter-Demo" style="color: #58a6ff; text-decoration: none;">Flutter-Demo</a></h3><p style="font-size: 14px;">No description available</p><p style="font-size: 12px;"><b>Language:</b> C++</p></div></p>
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/Commodity-trading-system-" style="color: #58a6ff; text-decoration: none;">Commodity-trading-system-</a></h3><p style="font-size: 14px;">My YouTube Channel: https://www.youtube.com/@yashsaundalkar658</p><p style="font-size: 12px;"><b>Language:</b> JavaScript</p></div></p>
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/SubAnime" style="color: #58a6ff; text-decoration: none;">SubAnime</a></h3><p style="font-size: 14px;">This webpage features `@keyframes` animations, hover effects, two types of slideshows, animated buttons, card hover pop-ups revealing information, and a footer, offering a visually engaging experience. My YouTube Channel: https://www.youtube.com/@yashsaundalkar658</p><p style="font-size: 12px;"><b>Language:</b> JavaScript</p></div></p>
<p align="center"><div style="display: inline-block; width: 45%; margin: 5px; padding: 10px; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0,0,0,0.1); background-color: #1e1e1e; color: white; text-align: left;"><h3 style="margin-bottom: 5px;"><a href="https://github.com/yashKappa/portfolio" style="color: #58a6ff; text-decoration: none;">portfolio</a></h3><p style="font-size: 14px;">My YouTube Channel: https://www.youtube.com/@yashsaundalkar658</p><p style="font-size: 12px;"><b>Language:</b> CSS</p></div></p>
<!-- LATEST-REPOS-END -->
